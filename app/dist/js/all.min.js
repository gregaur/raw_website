  ...
  var a;return function b(a, c, d) {
    function e(g, h) {
      ...
      (function () {
        var b = this || Function("return this")(),
          ...
          function b(a, b) {
            ...
            var d = b.match(a),
                e = b.replace(a, A);if (d) for (var f, g = d.length, h = 0; g > h; h++) {
            ...
            C.length = 0;for (var c = b.length, d = 0; c > d; d++) {
              C.push(a[b[d]]);
            }return C;
          }function q(a, b) {
      ...
      var d = a("shifty"),
          ...
          g = function h(a, b) {
        if (!(this instanceof h)) throw new Error("Constructor was called without new keyword");b = e.extend({ duration: 800, easing: "linear", from: {}, to: {}, step: function step() {} }, b);var c;c = e.isString(a) ? document.querySelector(a) : a, this.path = c, this._opts = b, this._tweenable = null;var d = this.path.getTotalLength();this.path.style.strokeDasharray = d + " " + d, this.set(0);
...
$(document).ready(function () {
	...
	function $blurinimage() {
		$poly2.animate(1, { duration: 3000 }, function () {
			//outer polygon is drawn 0s - 3s
			$explode();
		});
	}
